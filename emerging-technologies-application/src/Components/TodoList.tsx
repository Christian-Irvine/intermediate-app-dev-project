    ...
    <>
      <section class="h-screen bg-amber-100">
        ...
        <select
          ...
          id="filter"
          value={filter()}
          onChange={(value) => handleFilterChange(value.currentTarget.value)}
          class="mx-35 mt-10 p-3 bg-orange-100 rounded-2xl border-4 border-orange-200"
        >
        ...
        <section class="grid grid-cols-3 gap-20 px-35 mt-15 bg-amber-100">
            ...
            {(todo, i) => (
              <Show when={checkFilter(todo().isComplete)}>
                <TodoDisplay
                  ...
                  handleTodoModify={handleTodoModify}
                />
              </Show>
            )}
          </Index>
          <button
            ...
            class="bg-orange-100 rounded-full aspect-square border-4 border-orange-200 m-40 flex justify-center items-center font-bold align-middle text-9xl shadow-2xl"
          >
            +
          </button>
        </section>
